    ...
    <main className="p-3 md:p-4">
      <header className="flex justify-between">
        <div>
          ...
          <span className="text-sm text-[#919090] mt-2 block">
            {data.byline}
          </span>
          <time className="text-xs block mt-2 text-[#888]">
        ...
        <div className="flex flex-col justify-between">
          <span className="mt-4 text-2xl mx-auto text-gray-500 hover:text-gray-600">
            <Link to="/">
